                        ...
                        {props.users.map(user =>
                            <StyledTableRow key={user.id}>
                                ...
                                <StyledTableCell align="left">
                                        <Button className={classes.root} onClick={() => props.submitNewRole({adminRole})}>Add Admin Role</Button>
                                        <Button className={classes.root} onClick={() => props.submitNewRole({userRole})}>Add User Role</Button>
                                    </StyledTableCell>
